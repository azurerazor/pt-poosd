...
List<(_NightPhase, String, int)> _getNightScript(int numEvil, bool? includesMerlin, bool? includesPercival, bool? includesOberon, bool? includesMordred) {
  ...
  result.add((_NightPhase.end, "Everybody, open your eyes. The night is over. Good luck on your quests!", 1));
...
List<(_NightPhase, String, int)> _getEvilScript(int numEvil, bool? includesOberon) {
  ...
  List<(_NightPhase, String, int)> result = [
    (_NightPhase.evil, firstPart, 10), 
    (_NightPhase.evil, "All Minions of Mordred, close your eyes and put your hands down.", 4)
  ];
  return result;
}
...
List <(_NightPhase, String, int)> _getMerlinScript(int numEvil, bool? includesMordred) {
  ...
  List<(_NightPhase, String, int)> result = [
    (_NightPhase.merlin, firstPart, 10), 
    (_NightPhase.merlin, "Merlin, close your eyes. All Minions of Mordred, put your hands down.", 4),
  ];
  return result;
}
...
List<(_NightPhase, String, int)> _getPercivalScript() {
  List<(_NightPhase, String, int)> result = [
    (_NightPhase.percival, "Percival, open your eyes. Merlin and Morgana, keep your eyes closed and raise your hands. Percival, you should see 2 players with their hands raised.", 10),
    (_NightPhase.percival, "Percival, close your eyes. Merlin and Morgana, put your hands down. ", 4),
  ];
  return result;
}
