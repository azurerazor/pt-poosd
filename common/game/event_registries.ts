...
//   [K in StaticEventTypeFactories<T>]: T[K] extends EventTypeFactory<
//     infer TData,
//     infer TReply
//   >
//     ? EventType<TData, TReply, TEvent & GameEvent<TData>>
...
//  */
// export interface EventRegistry<TEvent extends GameEvent<any>>
//   extends SidedEvents<typeof Events, TEvent> {
//   /**
...
//    */
//   dispatch<TData, TReply>(event: TEvent & GameEvent<TData>): Promise<TReply>;
// }
...
//  */
// export function createEventRegistry<TEvent extends GameEvent<any>>(
//   socket: EventSocket<TEvent>,
...
//       const res = new EventType<TData, TReply, TEvent>(
//         id,
//         EventRegistry.socket,
//       );
...
//     addListener<TData, TReply>(
//       type: string,
//       listener: EventListener<TData, TReply, TEvent>,
//     ) {
...
//       if (!type) {
//         throw new Error(
//           `Attempting to dispatch unregistered event type: ${type}`,
//         );
//       }
